...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header logo-div bounceInLeft wow" data-wow-duration="2s">
      ...
      <a class="navbar-brand" href="#">AboboyaExpress</a>
    </div>
...
<div class="container wow bounceInDown" data-wow-duration="5s">
	<div class="row">
		<div class="col-md-offset-2 col-md-8 text-center slide-text">
			<h1>AboboyaExpress</h1>
			<p>AboboyaExpress is an initiative that seeks to help with keeping Ghana clean by providing an easy disposal option for areas that do not have waste disposal policies</p>
		</div><!-- End col-md-8-->
	...
	<div class="row">
		<div class="col-md-4 col-sm-6">
			<div class="features-div">
			   ...
			   <h4>Easy Access</h4>
			   <p>The website can easily be accessed on a phone or computer</p>
			</div>
		</div><!-- End col-md-3-->
		<div class="col-md-4 col-sm-6">
			<div class="features-div">
			   ...
			   <p>You can login to help store your data to make it easier to request for our service</p>
			</div>
		</div><!-- End col-md-3-->
		<div class="col-md-4 col-sm-6">
			<div class="features-div">
			   ...
			   <h4>24/7 Support</h4>
			   <p>We are always looking to improve on this initiative and are willing to listen to suggestions as well as to serve you by fixing your problems</p>
			</div>
		</div><!-- End col-md-3-->
	</div><!-- End row -->
</div><!-- End Container -->
