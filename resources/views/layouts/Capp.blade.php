...
<head>
    ...
    <link rel="shortcut icon" href="img/AboboyaExpress-logos.jpeg" type="image/x-icon" />
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        <div class="container">
          <a class="navbar-brand" href="{{route('collector.home')}}">
            <img src="img/AboboyaExpress-logos.jpeg" alt="..." height="36">
          </a>
          @auth
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              @auth
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="{{route('collector.profile')}}"><img src="{{ asset('/storage/images/profile/'.auth()->user()->profile_pic) }}" alt="Avatar" class="avatar mr-2"></a>
